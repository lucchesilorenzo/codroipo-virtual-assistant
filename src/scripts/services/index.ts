import { buildCartaIdentitaElettronicaFAQ } from "@/scripts/faq-builders/build-carta-identita-elettronica-faq";
...
import { ServiceDefinition } from "@/types/common-types";
...
import { scrapeCartaIdentitaElettronica } from "./scrape-carta-identita-elettronica";
import { scrapeCentriEstiviPerMinori } from "./scrape-centri-estivi-per-minori";

export const services = [
  {
    service: scrapeCartaIdentitaElettronica,
